...
# Load your dataset
file_path = "/models/git-base/telegram dataset/dataset_with_captions-git.csv"  # Update the path to your CSV file
...
output_path = "/semantic-similiarity/sbert/telegram dataset/git/dataset_with_similarity_git_own_dataset.csv"
