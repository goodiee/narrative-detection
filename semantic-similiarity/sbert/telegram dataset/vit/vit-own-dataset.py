...
# Load your dataset
file_path = "/models/vit/telegram dataset/dataset_with_captions-vit.csv"  # Update the path to your CSV file
...
image_desc_embeddings = model.encode(df['translated_message'].dropna().values.tolist(), convert_to_tensor=True)
...
output_path = os.path.join("/semantic-similiarity/sbert/telegram dataset/vit", "dataset_with_similarity_vit_own_dataset.csv")
