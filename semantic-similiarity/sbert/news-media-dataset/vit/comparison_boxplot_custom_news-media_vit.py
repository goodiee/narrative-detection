...
custom_data_path = "/semantic-similiarity/sbert/telegram dataset/vit/dataset_with_similarity_vit_own_dataset.csv"
custom_data = pd.read_csv(custom_data_path)

benchmark_data_path = "/semantic-similiarity/sbert/news-media-dataset/vit/dataset_with_similarity_vit.csv"
...
plt.savefig('semantic_similarity_boxplot_comparison_vit_with_median_on_yaxis.png', format='png')
plt.show()
plt.close()
