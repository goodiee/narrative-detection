...
# Load your dataset
file_path = "M:/VDU 2024-2025/thesis-project/models/git-base/news-media-dataset/dataset_with_captions-git.csv"  # Update the path to your CSV file
...
output_path = "/semantic-similiarity/sbert/news-media-dataset/git/dataset_with_similarity_git_own_dataset.csv"
